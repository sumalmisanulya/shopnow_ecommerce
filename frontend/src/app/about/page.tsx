  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-left relative z-10">
      ...
      <p className="text-zinc-400 text-base sm:text-lg leading-relaxed mb-8">
        ShopNow is a premium sandbox e-commerce website designed to showcase a modern, next-generation shopping platform. Built using Next.js 15, Tailwind CSS, Prisma, and Stripe, we focus on delivering fluid user experiences, rich animations, and lightning fast responsiveness.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-12">
        ...
        <div className="glass p-6 rounded-2xl border border-white/5 space-y-3">
          ...
          <p className="text-xs text-zinc-500 leading-relaxed">
            Engineered with React Server Components, Zustand state, next-auth sessions, and typed safety.
          </p>
        </div>
        <div className="glass p-6 rounded-2xl border border-white/5 space-y-3">
