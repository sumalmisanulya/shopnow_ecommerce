          ...
          <div className="glass p-6 rounded-2xl border border-white/5 text-left space-y-4">
            ...
            <div className="space-y-2 max-h-96 overflow-y-auto pr-1">
              {unassignedOrders.length === 0 ? (
                <p className="text-xs text-zinc-650 text-center py-8">All orders have been assigned drivers!</p>
              ) : (
              ...
              <form onSubmit={handleAssignSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-zinc-900 border border-white/10 rounded-xl py-2.5 px-3 text-sm text-zinc-200 focus:outline-none focus:border-violet-500"
                  >
                      ...
                      >
                        ...
                        <div className="space-y-2 text-xs text-zinc-400">
                          <div className="flex items-center gap-2">
                            <Truck className="w-3.5 h-3.5 text-zinc-650" />
                          ...
                          {matchedOrder && (
                            <div className="flex items-start gap-2 pt-2 border-t border-white/5">
                              <Navigation className="w-3.5 h-3.5 text-zinc-650 mt-0.5 shrink-0" />
                        ...
                        <div className="flex gap-2 pt-1.5 justify-end">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded hover:bg-rose-500/5 text-zinc-550 hover:text-rose-400 transition-colors"
                          >
