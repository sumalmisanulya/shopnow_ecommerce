...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-8 animate-slide-in">
      {/* Title */}
      <div>
        <h1 className="text-3xl font-extrabold text-zinc-100">Shop Settings</h1>
        <p className="text-sm text-zinc-500 mt-1">Configure global store attributes, checkout taxes, shipping limits, and developers mode.</p>
      </div>

      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start text-left">
          ...
          <div className="glass p-6 rounded-2xl border border-white/5 space-y-5">
            ...
            <div className="flex justify-between items-center bg-white/5 border border-white/5 rounded-xl p-4">
              <div>
                ...
                <p className="text-[10px] text-zinc-550 mt-1">Run in localStorage mock-DB mode.</p>
              </div>
              <button
                type="button"
            ...
            <div className="flex justify-between items-center bg-white/5 border border-white/5 rounded-xl p-4">
              <div>
                ...
                <p className="text-[10px] text-zinc-550 mt-1">Lock down client checkout routes.</p>
              </div>
              <button
                type="button"
            ...
            <div className="pt-2 flex flex-col gap-2">
              <button
                type="submit"
                disabled={isSaving}
                className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold bg-white text-zinc-950 hover:bg-zinc-150 transition-colors cursor-pointer text-sm shadow-md hover:shadow-lg disabled:opacity-50"
              >
              ...
              <button
                type="button"
                onClick={handleReset}
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl font-bold bg-zinc-850 hover:bg-zinc-800 text-zinc-400 hover:text-zinc-300 border border-white/5 transition-colors cursor-pointer text-xs"
              >
