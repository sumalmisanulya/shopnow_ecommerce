  ...
  return (
    <div className="space-y-8 animate-slide-in">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-zinc-100">Customer Inquiries</h1>
          <p className="text-sm text-zinc-500 mt-1">Audit guest feedback, support inquiries, and customer contact forms.</p>
        </div>
          ...
          {filteredMessages.map((ticket) => (
            ...
            >
              <div className="space-y-4">
                ...
                <div className="p-3 bg-zinc-950/40 border border-white/5 rounded-xl text-xs text-zinc-300 leading-relaxed font-sans whitespace-pre-line">
                  {ticket.message}
                </div>
              </div>
              ...
              <div className="flex justify-between items-center border-t border-white/5 pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded hover:bg-rose-500/5 text-zinc-500 hover:text-rose-455 transition-colors"
