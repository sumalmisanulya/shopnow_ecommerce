...
function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      showToast(err.message || "Invalid credentials. Try registering a new customer account or retrieve demo info!", "error");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      await registerStore(trimmedName, trimmedEmail, registerPassword);
